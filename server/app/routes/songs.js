...
router.get('/', function(req, res, next) {
  Song.scope('defaultScope', 'populated')
...
function showMetadata(metadata, res) {
  ...
  pic
    ? res.set('Content-Type', mime.lookup(pic.format)).send(pic.data)
