...
export default class Main extends React.Component {
  ...
  selectPlaylist = (playlistId) => {
    this.setState({selectedPlaylist : this.state.playlists[playlistId - 1]})
  }
	render() {
		const {
			albums,
      ...
      selectedPlaylist
		...
		return (
			<div id="main" className="container-fluid">
				<Sidebar playlists={playlists} handleSelect={this.selectPlaylist} />
				<div className="col-xs-10">
					<Switch>
						...
						<Route
							...
							exact
							render={() => (
								<FilterableArtistsContainer artists={artists} />
							)}
						/>
						<Route
							path="/addplaylist"
							...
							render={({history}) => (
								<PlayListContainer
									playlists={playlists}
									history={history}
									handleCreate={this.createPlaylist}
								/>
							)}
						/>
						<Route
